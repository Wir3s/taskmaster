      ...
      return(
        <div>
            ...
            <Dialog open={open} onClose={handleClose}>
                ...
                <DialogContent>
                    <DialogContentText>
                        You are about to delete the task "{props.taskName}". This cannot be undone and all subtasks will also be deleted. Please enter the task name below to confirm deletion.
                    </DialogContentText>
                    <TextField
                        autoFocus
                        margin="dense"
